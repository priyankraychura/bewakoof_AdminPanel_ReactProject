      ...
      <div className="main-add-products">
        <form onSubmit={handleOnSubmit}>
          <Box sx={{ display: 'flex', flexWrap: 'wrap' }}>
            ...
            <div>
              ...
              <SelectDropdown
                ...
                isDisabled={formData.category == "" ? true : false}
              />
                    ...
                    return (
                      <div className='images-field'>
                        ...
                        {formData.images.length > 1 ?
                          <Button onClick={(el) => handleRemoveImage(el, index)} variant="outlined" color='error' sx={{ m: 1, width: '15ch', height: '7ch' }}>Remove</Button> : ""}
                      </div>
                    )
                  })
                }
          ...
          <div className="add-btns" >
            <Link to={"/"}><Button variant="outlined" color="error" sx={{ width: '45ch' }}>Cancel</Button></Link>
